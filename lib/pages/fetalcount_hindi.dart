...
class Home_h extends StatefulWidget {
  @override
  _HomeState_h createState() => _HomeState_h();
}

class _HomeState_h extends State<Home_h> {
  int seconds = 0, minutes = 0, hours = 0;
  int _counter = 0;
  Timer timer;
  bool active = false;
  List laps = ["अवधि - किक्स"];
