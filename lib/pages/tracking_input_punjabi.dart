...
import 'package:Tiny_Toes/pages/flare_controller.dart';

class TrackingInput_p extends StatefulWidget {
  @override
  TrackingState_p createState() => TrackingState_p();
}

class TrackingState_p extends State<TrackingInput_p> {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 20),
                  Text(
                    "ਸਿਫ਼ਾਰਿਸ਼ ਕੀਤੀ ਮਾਤਰਾ = 8-12 ਗਲਾਸ",
                    style: TextStyle(
                        fontWeight: FontWeight.normal,
                        color: Colors.white,
                        fontSize: 16.0),
