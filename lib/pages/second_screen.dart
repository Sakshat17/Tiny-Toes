    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(height: 130, child: Image.asset('assets/cloud.png')),
          const SizedBox(
            height: 10.0,
          ),
          Card(
          ...
          RaisedButton(
            onPressed: () {
              ...
              SleepRecord(currentDateTime:DateTime.now(), dropdownSelectedValue:selectedValue,  selectedDuration:sleepDuration);
