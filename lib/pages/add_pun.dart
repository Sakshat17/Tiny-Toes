...
class AddEntryDialog_p extends StatefulWidget {
  @override
  AddEntryDialogState createState() => new AddEntryDialogState();
}

class AddEntryDialogState extends State<AddEntryDialog_p> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: new AppBar(
      title: const Text('ਨਵੀਂ ਐਂਟਰੀ'),
      actions: [
        new FlatButton(
            onPressed: _saveButtonClk,
            child: new Text('ਸੇਵ ਕਰੋ', style: Theme.of(context).textTheme.subtitle1.copyWith(color: Colors.white))),
      ],
    ),
    body: Column(
      children: <Widget>[
