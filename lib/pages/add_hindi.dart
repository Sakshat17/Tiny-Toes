...
import 'package:Tiny_Toes/pages/dateTimeItem.dart';
import 'package:numberpicker/numberpicker.dart';
import 'dart:math';

class AddEntryDialog_h extends StatefulWidget {
  @override
  AddEntryDialogState createState() => new AddEntryDialogState();
}

class AddEntryDialogState extends State<AddEntryDialog_h> {
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: new AppBar(
      title: const Text(' नविन प्रवेश'),
      actions: [
        new FlatButton(
            onPressed: _saveButtonClk,
            child: new Text('सहेजें', style: Theme.of(context).textTheme.subtitle1.copyWith(color: Colors.white))),
      ],
    ),
    body: Column(
      children: <Widget>[
